<%@ Page Title="" Language="VB" MasterPageFile="~/Pages/SiteMaster.master" AutoEventWireup="false" CodeFile="ReporteCtaCte.aspx.vb" Inherits="Reportes_ReporteCtaCte" %>
            ...
            <asp:UpdatePanel runat="server" ID="upFiltros">
                <ContentTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:TextBox runat="server" ID="txtFecPagoA" CssClass="estandar-control Fecha Centro" Width="130px" ></asp:TextBox>
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
