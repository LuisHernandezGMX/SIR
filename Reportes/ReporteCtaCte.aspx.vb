...
Partial Class Reportes_ReporteCtaCte
    ...
    Private Sub btn_Reporte_Click(sender As Object, e As EventArgs) Handles btn_Reporte.Click
        Try
            ...
            server = Replace(Replace(server, "@Reporte", "DetCtaCorriente"), "@Formato", "EXCEL") & "&fecha_desde=" & CDate(txtFecPagoDe.Text).ToString("yyyyMMdd") & "&fecha_hasta=" & CDate(txtFecPagoA.Text).ToString("yyyyMMdd") & "&Tipo_repo=" & ddl_Agrupado.SelectedValue & "&cod_agente=-1&tipo_contrato=" & ddl_TipoContrato.SelectedValue
