<%@ Page Title="" Language="VB" MasterPageFile="~/Pages/SiteMaster.master" AutoEventWireup="false" CodeFile="GarantiasPago.aspx.vb" Inherits="OrdenPago_GarantiasPago" %>
<%@ MasterType VirtualPath="~/Pages/SiteMaster.master" %>

<asp:Content ID="Content2" ContentPlaceHolderID="cph_principal" Runat="Server">
    <script src="../Scripts/Reporteador.js"></script>
    <asp:HiddenField runat="server" ID="hid_Ventanas" Value="1|1|1|1|1|1|1|1|1|" />
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float2" ImageUrl="../Images/float_mini.png" AlternateText="#div_contabilidad" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide2" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_contabilidad" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana5" class="panel-subcontenido ventana2">
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float3" ImageUrl="../Images/float_mini.png" AlternateText="#div_poliza" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide3" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_poliza" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana6" class="panel-subcontenido ventana3">
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float4" ImageUrl="../Images/float_mini.png" AlternateText="#div_broker" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide4" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_broker" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana7" class="panel-subcontenido ventana4">
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float5" ImageUrl="../Images/float_mini.png" AlternateText="#div_compañia" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide5" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_compañia" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana8" class="panel-subcontenido ventana5">
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float6" ImageUrl="../Images/float_mini.png" AlternateText="#div_ramo_contable" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide6" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_ramo_contable" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana9" class="panel-subcontenido ventana6">
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float7" ImageUrl="../Images/float_mini.png" AlternateText="#div_producto" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide7" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_producto" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana10" class="panel-subcontenido ventana7">
                        ...
                        <ContentTemplate>
                            <div class="cuadro-subtitulo-flotante">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:ImageButton runat="server" ID="btn_float8" ImageUrl="../Images/float_mini.png" AlternateText="#div_adicionales" OnClick="Flotante_Click" />
                                        <asp:ImageButton runat="server" ID="btn_hide8" ImageUrl="../Images/autohide_mini.png" AlternateText="#div_adicionales" OnClick="Esconde_Click" />
                                    </div>
                                </div>
                            </div>
               

                            <div id="ventana11" class="panel-subcontenido ventana8">
